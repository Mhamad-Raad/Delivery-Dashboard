        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BuildingName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2738d25f-ebd2-4473-816a-5771b5f7c42f"), null, "Vendor", "VENDOR" },
                    { new Guid("768c88f6-9438-4714-acfe-8f9239836c98"), null, "SuperAdmin", "SUPERADMIN" },
                    { new Guid("cd56803c-f8ba-4f59-92ff-faee35d567e4"), null, "Admin", "ADMIN" },
                    { new Guid("d90d48fd-655a-423c-ae20-23fe71107116"), null, "Tenants", "TENANTS" }
                });
