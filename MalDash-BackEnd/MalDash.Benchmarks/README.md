...
Performance benchmarking project for MalDash using [BenchmarkDotNet](https://benchmarkdotnet.org/).
...
1. Set `MalDash.Benchmarks` as startup project
...
namespace MalDash.Benchmarks.Services;
