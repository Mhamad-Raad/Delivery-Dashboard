...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Apartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Catagory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.DriverShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.EntityImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Floor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.OrderAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.VendorStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Address", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.Apartment", "Apartment")
                        .WithMany("Addresses")
                        .HasForeignKey("ApartmentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MalDash.Domain.Entities.Building", "Building")
                        .WithMany("Addresses")
                        .HasForeignKey("BuildingId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MalDash.Domain.Entities.Floor", "Floor")
                        .WithMany("Addresses")
                        .HasForeignKey("FloorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MalDash.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Catagory", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.Catagory", "ParentCategory")
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.DriverShift", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.User", "Driver")
                        .WithMany()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Order", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.Address", "DeliveryAddress")
                        .WithMany()
                    ...
                    b.HasOne("MalDash.Domain.Entities.Vendor", "Vendor")
                        .WithMany()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.OrderAssignment", b =>
                {
                    ...
                    b.HasOne("MalDash.Domain.Entities.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MalDash.Domain.Entities.DriverShift", "Shift")
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("MalDash.Domain.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MalDash.Domain.Entities.Product", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.Catagory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("MalDash.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
