...
interface VendorCategoriesFiltersProps {
  onCreate: () => void;
}

export default function VendorCategoriesFilters({
  onCreate,
}: VendorCategoriesFiltersProps) {
  ...
  return (
    <div className='flex flex-col gap-5'>
      ...
      <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-4'>
        ...
        <Button type='button' onClick={onCreate} className='gap-2' size='default'>
      ...
      <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-2xl border bg-card/50 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 relative z-30'>
        ...
        <div className='flex flex-col sm:flex-row flex-1 items-start sm:items-center gap-3 w-full transition-all duration-300'>
          ...
          <div className='relative w-full sm:flex-1'>
            <CheckCircle2 className='absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-muted-foreground z-10 pointer-events-none' />
